...
/**
 * A solid block with real translucency (per-vertex alpha in the shared
 * tesselator), e.g. leaves. Unlike {@link WaterBlock}, transparent blocks are
 * physically solid — the player stands on them — and faces are culled against
 * neighbouring solid blocks (so adjacent leaf blocks only draw their outer
 * shell instead of double-shading every shared wall).
 *
 * <p>Block XMLs use {@code <type>transparent</type>} to get this renderer.
 */
public class TransparentBlock extends Block {

    private static final float ALPHA = 0.7F;

    public TransparentBlock(int id, String name, int tileTop, int tileSide, int tileBottom,
    ...
    public TransparentBlock(int id, String name, String iconName, java.awt.image.BufferedImage icon,
